...
#ifndef KZ_RESOURCE_PROFILING_LOAD_CONTEXT_HPP
#define KZ_RESOURCE_PROFILING_LOAD_CONTEXT_HPP
...
class KANZI_API ResourceProfilingLoadContext : public NamedResourceProfilingContext
{
public:
    /// The context sampler.
...
protected:
    ...
    explicit ResourceProfilingLoadContext(TimeStamp entryTimeStamp, ResourceProfilingDataSampleSharedPtr profiledResource);
