...
#ifndef KZ_GL_COLOR_BRUSH_RENDERER_HPP
#define KZ_GL_COLOR_BRUSH_RENDERER_HPP
...
class ColorBrushRenderer : public GlBrushRenderer
{
public:
...
protected:
    ...
    /// \param brush Brush to use.
    /// \param node Node to attach to.
    explicit ColorBrushRenderer(Brush* brush, Node* node) :
...
private:
    ...
    /// Render value.
    GlRenderValue<ColorRGBA> m_colorValue;
    /// Render value.
    ...
    /// Property listener.
    RenderValuePropertyNotificationHandler<ColorRGBA> m_colorProperty;
};
