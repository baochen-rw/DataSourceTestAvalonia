...
#ifndef KZ_INTEGRITY_READ_ONLY_DISK_FILE_HPP
#define KZ_INTEGRITY_READ_ONLY_DISK_FILE_HPP
...
protected:
    /// Constructor.
    /// \param fileDescriptor An open disk file descriptor.
    explicit ReadOnlyDiskFile(int fileDescriptor);
