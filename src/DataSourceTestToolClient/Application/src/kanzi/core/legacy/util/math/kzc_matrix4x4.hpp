...
extern KANZI_API const struct KzcMatrix4x4 KZC_MATRIX4X4_IDENTITY;
/** Constant for NaN matrix. */
extern KANZI_API const struct KzcMatrix4x4 KZC_MATRIX4X4_NAN;
/** Constant for shadow map bias matrix. */
extern KANZI_API const struct KzcMatrix4x4 KZC_MATRIX4X4_SHADOW_MAP_BIAS;
...
KANZI_API void kzcMatrix4x4CreateSRT(struct KzcMatrix4x4* matrix, kzFloat scaleX, kzFloat scaleY, kzFloat scaleZ, 
