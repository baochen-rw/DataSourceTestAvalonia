...
struct KzcRectangle
{
    ...
    KzcRectangle() : x(0.0f), y(0.0f), width(0.0f), height(0.0f) {}
    KzcRectangle(kzFloat xArg, kzFloat yArg, kzFloat widthArg, kzFloat heightArg)
        : x(xArg), y(yArg), width(widthArg), height(heightArg) {}
    KzcRectangle(const struct KzcVector2& offset, const struct KzcVector2& size)
        : x(offset.data[0]), y(offset.data[1]), width(size.data[0]), height(size.data[1]) {}
};
                                                                    ...
                                                                    const struct KzcVector2* point3, const struct KzcVector2* point4)
{
    ...
    rectangle.height = kzsMaxf(kzsMaxf(kzsMaxf(y1, y2), y3), y4) - rectangle.y;
...
inline bool operator==(KzcRectangle rectangle1, KzcRectangle rectangle2)
{
...
{
    return (kzsFloatIsAlmostEqual(rectangle1->x, rectangle2->x) && kzsFloatIsAlmostEqual(rectangle1->width, rectangle2->width) &&
        kzsFloatIsAlmostEqual(rectangle1->y, rectangle2->y) && kzsFloatIsAlmostEqual(rectangle1->height, rectangle2->height));
}
