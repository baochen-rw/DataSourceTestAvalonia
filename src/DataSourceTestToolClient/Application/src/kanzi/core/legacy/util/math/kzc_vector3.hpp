...
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_ZERO;
/** Constant unit 3D vector for X axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_X_AXIS;
/** Constant unit 3D vector for Y axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_Y_AXIS;
/** Constant unit 3D vector for Z axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_Z_AXIS;
/** Constant unit 3D vector for negative X axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_X_AXIS_NEGATIVE;
/** Constant unit 3D vector for negative Y axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_Y_AXIS_NEGATIVE;
/** Constant unit 3D vector for negative Z axis. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_Z_AXIS_NEGATIVE;
/** Constant 3D vector with each field at maximum. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_MAXIMUM;
/** Constant 3D vector with each field at minimum. */
extern KANZI_API const struct KzcVector3 KZC_VECTOR3_MINIMUM;
