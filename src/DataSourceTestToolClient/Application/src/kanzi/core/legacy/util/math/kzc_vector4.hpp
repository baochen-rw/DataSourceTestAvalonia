...
extern KANZI_API const struct KzcVector4 KZC_VECTOR4_ZERO;
/** Constant unit 4D vector for X axis. */
extern KANZI_API const struct KzcVector4 KZC_VECTOR4_X_AXIS;
/** Constant unit 4D vector for Y axis. */
extern KANZI_API const struct KzcVector4 KZC_VECTOR4_Y_AXIS;
/** Constant unit 4D vector for Z axis. */
extern KANZI_API const struct KzcVector4 KZC_VECTOR4_Z_AXIS;
...
KZ_INLINE void kzcVector4ComponentModulo(const struct KzcVector4* first, const struct KzcVector4* second, struct KzcVector4* targetVector)
{
    ...
    targetVector->data[2] = kzsFmod(first->data[2], second->data[2]);
    targetVector->data[3] = kzsFmod(first->data[3], second->data[3]);
}
...
KZ_INLINE void kzcVector4ComponentAbs(const struct KzcVector4* vector, struct KzcVector4* out_vector)
{
    ...
    out_vector->data[3] = kzsFabsf(vector->data[3]);
}
...
KZ_INLINE void kzcVector4ComponentCeil(const struct KzcVector4* vector, struct KzcVector4* out_vector)
{
    ...
    out_vector->data[3] = kzsCeilf(vector->data[3]);
}
...
KZ_INLINE void kzcVector4ComponentFloor(const struct KzcVector4* vector, struct KzcVector4* out_vector)
{
    ...
    out_vector->data[3] = kzsFloorf(vector->data[3]);
}
...
KZ_INLINE void kzcVector4ComponentRound(const struct KzcVector4* vector, struct KzcVector4* out_vector)
{
    ...
    out_vector->data[3] = kzsRoundf(vector->data[3]);
}
...
KZ_INLINE void kzcVector4ComponentSqrt(const struct KzcVector4* vector, struct KzcVector4* out_vector)
{
    ...
    out_vector->data[3] = kzsSqrtf(vector->data[3]);
}
...
{
    out_vector->data[0] = kanzi::pow(vector->data[0], exponent);
    out_vector->data[1] = kanzi::pow(vector->data[1], exponent);
    out_vector->data[2] = kanzi::pow(vector->data[2], exponent);
    out_vector->data[3] = kanzi::pow(vector->data[3], exponent);
}
...
{
    return kzcVector4(kzsStepf(kzcVector4GetX(vectorA), kzcVector4GetX(vectorB)),
        kzsStepf(kzcVector4GetY(vectorA), kzcVector4GetY(vectorB)),
        kzsStepf(kzcVector4GetZ(vectorA), kzcVector4GetZ(vectorB)),
        kzsStepf(kzcVector4GetW(vectorA), kzcVector4GetW(vectorB)));
}
