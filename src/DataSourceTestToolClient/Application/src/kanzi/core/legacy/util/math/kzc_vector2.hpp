...
extern KANZI_API const struct KzcVector2 KZC_VECTOR2_ZERO;
/** Constant unit 2D vector for X axis. */
extern KANZI_API const struct KzcVector2 KZC_VECTOR2_X_AXIS;
/** Constant unit 2D vector for Y axis. */
extern KANZI_API const struct KzcVector2 KZC_VECTOR2_Y_AXIS;
/** Constant unit 2D vector for negative X axis. */
extern KANZI_API const struct KzcVector2 KZC_VECTOR2_X_AXIS_NEGATIVE;
/** Constant unit 2D vector for negative Y axis. */
extern KANZI_API const struct KzcVector2 KZC_VECTOR2_Y_AXIS_NEGATIVE;
