...
#define KZS_ERROR_WINDOW_MODIFICATION_FAILED (kzsError)10303 /**< Failed to modify window. */
#define KZS_EXCEPTION_WINDOW_MODIFICATION_FAILED (kzsError)(-10303) /**< Failed to modify window. */
...
#define KZS_ERROR_DISPLAY_OPENGL_NOT_SUPPORTED (kzsError)10308 /**< Unsupported OpenGL version. */
...
#define KZS_ERROR_INPUT_INITIALIZATION_FAILED ((kzsException)10703) /**< Input subsystem initialization failed. */
