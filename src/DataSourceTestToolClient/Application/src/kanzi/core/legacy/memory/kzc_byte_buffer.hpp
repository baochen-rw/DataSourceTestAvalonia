...
{
    kzAssert(buffer->state_private.offset_private + size <= buffer->state_private.size_private);
...
{
    kzAssert(buffer->offset_private + offset <= buffer->size_private);
...
{
    kzAssert(offset <= buffer->size_private);
...
{
    kzAssert(buffer->offset_private <= buffer->size_private);
